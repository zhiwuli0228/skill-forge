...
## Purpose
Define how Skill Forge keeps user-facing documentation, roadmap notes, and archived main specs aligned with the implemented CLI surface. This capability ensures completed features are documented as available, future work is clearly separated, and documentation cleanup does not change runtime behavior.
## Requirements

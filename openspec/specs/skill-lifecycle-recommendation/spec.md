...
## Purpose
Define a deterministic, read-only recommendation layer on top of the Skill lifecycle index. This capability turns lifecycle state into a next best action and compares two generated Skills without mutating packages or experience data.
## Requirements
